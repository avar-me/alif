...
LATIN_LETTERS = [
    ...
    },
    {
        ...
        "cyrillic": "ЦӀ цӀ",
        "ipa": "[t͡sʼ]",
        "desc": "Эйективная (абруптивная) переднеязычная свистящая аффриката. Можно писать и c̣ (c с точкой снизу), по аналогии с другими абруптивами, но такой знак есть не на всех клавиатурах, поэтому используется ć.",
        "cyr_keys": ["цӀ"],
    },
    {
        "id": "c-cedilla",
    ...
    },
    {
        ...
        "cyrillic": "ЧӀ чӀ",
        "ipa": "[t͡ʃʼ]",
        "desc": "Эйективная (абруптивная) переднеязычная шипящая аффриката. Аналогично ć можно писать č̣ (с точкой снизу), но из-за ограничений клавиатур используется č.",
        "cyr_keys": ["чӀ"],
    },
    {
        "id": "d",
    ...
    },
    {
        ...
        "cyrillic": "КӀ кӀ",
        "ipa": "[kʼ]",
        "desc": "Эйективный (абруптивный) заднеязычный смычный согласный. Обратный случай: по аналогии ожидался бы знак с акутом (ḱ) или точкой снизу, но такого символа нет на клавиатурах, поэтому используется буква с чертой снизу — ķ.",
        "cyr_keys": ["кӀ"],
    },
    {
        "id": "q",
    ...
    },
    {
        ...
        "cyrillic": "ТӀ тӀ",
        "ipa": "[tʼ]",
        "desc": "Эйективный (абруптивный) переднеязычный смычный согласный. Аналогично можно писать ṭ (t с точкой снизу), но из-за ограничений клавиатур используется ť.",
        "cyr_keys": ["тӀ"],
    },
    {
        "id": "u",
