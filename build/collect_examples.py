...
LATIN_LETTERS = [
    ...
    },
    {
        ...
        "cyrillic": "ЦӀ цӀ",
        "ipa": "[t͡sʼ]",
        "desc": "Эйективная (абруптивная) переднеязычная свистящая аффриката. Абруптивность обозначена акутом. Существует и вариант с точкой снизу — c̣, но этот знак есть не на всех клавиатурах, поэтому в avar.me используется ć. Например: цӏа «огонь» → ća (вариант с точкой снизу: c̣a).",
        "cyr_keys": ["цӀ"],
    },
    {
        "id": "c-cedilla",
        ...
        "cyrillic": "Ч ч",
        "ipa": "[t͡ʃ]",
        "desc": "Глухая переднеязычная шипящая аффриката. Выбор буквы соответствует турецкой орфографии (ç = [t͡ʃ]).",
        "cyr_keys": ["ч"],
    },
    {
        "id": "c-caron",
        ...
        "cyrillic": "ЧӀ чӀ",
        "ipa": "[t͡ʃʼ]",
        "desc": "Эйективная (абруптивная) переднеязычная шипящая аффриката. Абруптивность обозначена гачеком. Существует и вариант с точкой снизу — č̣, но этот знак есть не на всех клавиатурах, поэтому используется č. Например: чӏабар «земляной пол» → čabar (вариант с точкой снизу: č̣abar).",
        "cyr_keys": ["чӀ"],
    },
    {
        "id": "d",
    ...
    },
    {
        ...
        "cyrillic": "КӀ кӀ",
        "ipa": "[kʼ]",
        "desc": "Эйективный (абруптивный) заднеязычный смычный согласный. Здесь абруптивность обозначена не акутом, а чертой снизу: знак ḱ (k с акутом) есть не на всех клавиатурах, поэтому используется ķ. Например: кӏада «крупный глиняный сосуд» → ķada (вариант с акутом: ḱada).",
        "cyr_keys": ["кӀ"],
    },
    {
        "id": "q",
    ...
    },
    {
        ...
        "cyrillic": "ТӀ тӀ",
        "ipa": "[tʼ]",
        "desc": "Эйективный (абруптивный) переднеязычный смычный согласный. Абруптивность обозначена гачеком. Существует и вариант с точкой снизу — ṭ, но этот знак есть не на всех клавиатурах, поэтому используется ť. Например: тӏабгӏ «характер» → ťabġ (вариант с точкой снизу: ṭabġ).",
        "cyr_keys": ["тӀ"],
    },
    {
        "id": "u",
    ...
    },
    {
        ...
        "upper": "Y",
        "lower": "y",
        "cyrillic": "Й й (также в я, ю, ё)",
        "ipa": "[j]",
        "desc": "Палатальный аппроксимант (полугласный). Служит также основой для йотированных гласных: ya (я), yu (ю), yo (ё). Для ё можно было бы использовать отдельную букву ö, но все слова с буквой ё в аварском — русские кальки, не являющиеся нативными для языка, поэтому используется буквосочетание yo, например: актёр → aktyor.",
        "cyr_keys": ["й", "я", "ю", "ё"],
    },
    {
        "id": "z",
